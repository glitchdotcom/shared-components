  ...
  <>
    ...
    <PropsDefinition>
      ...
      <Prop name="label" required>
        The content of the button that identifies and triggers the popover. Will likely be styled as an icon or a button, and should have an accessible label.
      </Prop>
      <Prop name="views">
        An object mapping the names of secondary popover pages to functions that render them.
      </Prop>
      <Prop name="initialView">
        If provided, the popover will open in this view instead of the one in the "children" prop.
      </Prop>
    ...
    <Popover align="left" label={<Button as="span">Delete Team</Button>}>
...
export const _StoryPopoverMenu_with_Multiple_Views = () => (
  <>
    <p>
      Popover components can render multi-page popovers
    </p>
    <Popover
      align="left"
