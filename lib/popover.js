...
export const Popover = ({ align, renderLabel, views = {}, initialView, startOpen, children, contentProps, ...props }) => {
  ...
  return (
    <PopoverContainer data-module="Popover" ref={rootRef} {...props}>
      {renderLabel({ onClick: onToggle, ref: toggleRef, open })}
      {open && (
...
export const StoryPopover = () => (
  <>
    <p>
      The Popover component renders accessible and nestable popovers. See{' '}
      <a href="#Story_Blocks_for_Overlay_and_Popover_content">blocks to use with Popovers</a>.
    </p>
    <CodeExample>
      {code`
        <Popover
    ...
    <PropsDefinition>
      ...
      <Prop name="renderLabel" required>
        ...
        <dl>
          ...
          <dt>open</dt>
          <dd>Whether the popover is open or not.</dd>
        </dl>
      </Prop>
      ...
      <Prop name="startOpen">Should the popover be open when the component is first rendered</Prop>
    </PropsDefinition>
    <Popover align="left" startOpen={false} renderLabel={(labelProps) => <Button {...labelProps}>Delete Team</Button>}>
