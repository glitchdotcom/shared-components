...
/*
  ...
  - as with all optimisticTextInputs if an error is hit in the onchange or onblur, it'll show a default error state (right now that's a little firetruck)
*/
...
export const StoryEditableProjectDomain = () => {
  ...
  return (
  <>
    <p>The EditableProjectDomain Component is a souped up OptimisticTextInput designed for when users want to edit their project domain</p>
    <PropsDefinition>
