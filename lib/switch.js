...
export const StorySwitch = () => {
  ...
  return (
    <>
      ...
      <CodeExample>{code`<Switch value={notificationsEnabled} onChange={setNotificationsEnabled} label="Enable notifications" />`}</CodeExample>
      <PropsDefinition>
      ...
      <h3>
        Notifications settings <Switch value={value} onChange={onChange} label="Enable notifications" />
      </h3>
    </>
  );
};
