...
const variantNames = ['tertiary', 'private', 'cta', 'error', 'warning', 'info', 'success', 'selected'];
...
export const darkText = (background) => ({ hasLightText: false, background })
export const lightText = (background) => ({ hasLightText: true, background })

export const colorSystem = (options) => {
