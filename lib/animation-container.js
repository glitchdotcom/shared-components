    ...
    <>
      ...
      <PropsDefinition>
        <Prop name="animation" required>
          The CSS animation to run. Can either be the name of an animation declared in a stylesheet or an object returned from <code>styled.keyframes</code>.
        </Prop>
        <Prop name="duration">
          The duration of the animation. Defaults to "0.1s".
        </Prop>
