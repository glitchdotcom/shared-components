...
export const StoryAnimationContainer = () => {
  ...
  return (
    <div>
      ...
      <CodeExample>
        {code`
          <AnimationContainer animation="slideUp" onAnimationEnd={featureProject}>
            {(animateThenFeature) => <Project onFeature={animateThenFeature} />}
          </AnimationContainer>
        `}
      </CodeExample>
      <PropsDefinition>
        <Prop name="animation" required>
          The name of the CSS animation to run.
        </Prop>
