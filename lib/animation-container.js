...
import { oneOfObject, func } from './prop-types'
// stories
...
AnimationContainer.propTypes = {
  animation: oneOfObject(animations),
  children: func('(<the same function passed to onAnimationEnd>) => node'),
  onAnimationEnd: func('(...any) => {}'),
};
