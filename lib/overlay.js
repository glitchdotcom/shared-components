...
export const StoryOverlay = () => {
  ...
  return (
    <>
      <p>
        The Overlay component renders an accessible modal.
      </p>
      <CodeExample>
        {code`
      ...
      <PropsDefinition>
        ...
        <Prop name="children" required>
          ...
          <dl>
            ...
            <dt>first</dt>
            <dd>A ref to the <em>first</em> focusable element in the overlay (for trapping focus).</dd>
            <dt>last</dt>
            <dd>A ref to the <em>last</em> focusable element in the overlay (for trapping focus).</dd>
