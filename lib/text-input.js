...
export const TextInput = React.forwardRef(({ label, type, value, onChange, variant, error, prefix, postfix, labelProps, placeholder, ...props }, ref) => (
...
export const TextArea = React.forwardRef(({ label, value, onChange, variant, error, labelProps, placeholder, ...props }, ref) => (
