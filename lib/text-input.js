...
const ErrorIcon = withProps(
  styled(Icon)`
    font-size: var(--fontSizes-bigger);
  `,
  { icon: 'fireEngine', alt: 'Warning' },
);
...
const Container = styled((props) => <Box rounded variant="secondary" padding={1} mx={0} {...props} />)`
  max-width: 400px;
  & > * + * {
