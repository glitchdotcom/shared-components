...
export const StoryTextInput = () => (
  <>
    ...
    <PropsDefinition>
      <dd name="label" required>The label for this field as it appears to screen readers and (by default) as placeholder text.</dd>
      <dd name="value" required>The value of the form input.</dd>
      <dd name="onChange" required>A callback function, which is called with the input's new value on change events.</dd>
      <dd name="type">"text", "email", "password", or "search" (default "text").</dd>
      <dd name="variant">The input's visual style: "underline" or "opaque" (default "underline").</dd>
      <dd name="placeholder">Custom text for the placeholder (defaults to the "label" value).</dd>
      <dt>error</dt>
...
export const StoryTextArea = () => (
  <>
    ...
    <PropsDefinition>
      <Prop name="label" required>The label for this field as it appears to screen readers and (by default) as placeholder text.</Prop>
      <Prop name="value" required>The value of the form input.</Prop>
      <Prop name="onChange" required>A callback function, which is called with the input's new value on change events.</Prop>
