...
export const story_TextInput = () => {
  ...
  const [hasValidEmail, setValidEmail] = React.useState(false)
  ...
  return (
    <Container>
      ...
      <TextInput type="email" label="email" placeholder="your email" value={email} onChange={(val) => setEmail(val)} onBlur={validateEmail} />
    </Container>
  )
}