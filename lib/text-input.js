...
export const StoryTextInput_and_TextArea_overrides = () => (
  <>
    <p>
      The styles and behavior of TextInput and TextArea components can be overridden with the "className" or "as" props, 
      or by wrapping in a <code>styled</code> helper.
    </p>
    <CodeExample>
      {code`
        const BoldTextInput = styled(TextInput)\`
