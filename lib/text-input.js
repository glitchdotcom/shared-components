...
export const StoryTextInput_and_TextArea_variants = () => (
  <>
    ...
    <Container>
      ...
      <TextArea label="description" rows={3} {...useInputState('Feature: TextInput and TextArea components')} />
    </Container>
    <h3>opaque</h3>
    <Container>
    ...
    <>
      <CodeExample>
        {code`
          ...
          <TextArea label="description" as={TextAreaAutosize} value={description} onChange={setDescription} />
        `}
      </CodeExample>
      <Container>
        <BoldTextInput label="name" {...useInputState('stingy-argument')} />
        <TextArea label="description" as={Autosize} {...useInputState('Feature: TextInput and TextArea components')} />
      </Container>
    </>
  );
};
