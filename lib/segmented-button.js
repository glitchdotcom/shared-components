...
// TODO: grouped buttons that don't work like radio buttons (e.g. the search results navigation in the editor)
// Looks the same, but uses { options, onClick, size }, no 'value'
...
SegmentedButton.propTypes = {
  ...
  size: PropTypes.oneOf(['small', 'large']), // TODO: does this do anything weird when PropTypes are stripped in production?
};
