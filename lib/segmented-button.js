...
export const StoryButtonGroup = () => {
  return (
    <ButtonGroup variant="secondary">
      <ButtonSegment onClick={noop}><SoftIcon icon="chevronLeft" /></ButtonSegment>
      <ButtonSegment onClick={noop}><SoftIcon icon="chevronRight" /></ButtonSegment>
      <ButtonSegment onClick={noop}><SoftIcon icon="x" /></ButtonSegment>
...
export const StorySegmentedButton = () => {
  ...
  return (
    <>
      ...
      <Wrap>
        <SegmentedButton size="tiny" value={valueSmall} onChange={(id) => onChangeSmall(id)} options={options} />
      </Wrap>
    </>
  );
};
