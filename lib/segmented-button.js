...
const BadgeInButton = styled(Badge)`
  margin-top: -1em; // this will pull the badge up as far as it will go
`


const SearchBadge = ({ count }) => (
  <BadgeInButton variant="warning">{count} <BadgeIcon icon="search" /></BadgeInButton>
)
...
export const story_ButtonGroup = () => {
  return (
    <ButtonGroup variant="secondary">
      ...
      <ButtonSegment onClick={noop}>foo <SearchBadge count={123} /></ButtonSegment>
    </ButtonGroup>
  )
}
