...
export const StoryLoader_sizes = () => (
  <>
    <p>Icon sizes are configurable with the "size" property, which scale 1.5x to the theme's font sizes.</p>
    <Loader size="tiny" />
    &nbsp;
    <Loader size="small" />
    &nbsp;
    ...
    <Loader size="huge" />
    &nbsp;
    <p>Loaders with the size "inline" match the size of their surrounding text.</p>
    <h2>
