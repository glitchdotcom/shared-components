...
const icons = {
  ambulance:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f691.svg',
  arrowBackward:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/25c0.svg',
  backhandIndex:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f447.svg',
  balloon:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f388.svg',
  bentoBox:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f371.svg',
  bicep:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4aa.svg',
  blockArrowDown:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2b07.svg',
  blockArrowUp:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2b06.svg',
  bomb:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4a3.svg',
  boosted:
  ...
  carpStreamer:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f38f.svg',
  clap:
  ...
  coffin:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/26b0.svg',
  creditCard:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4b3.svg',
  crescentMoon:
  ...
  dancers:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f46f-200d-2640-fe0f.svg',
  dev:
  ...
  email:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4e7.svg',
  eyeglasses:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f453.svg',
  eyes:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f440.svg',
  facebook:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Ffacebook.png?v=1568142112883',
  faceExpressionless:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f611.svg',
  faceSlightlySmiling:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f642.svg',
  fastDown:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/23ec.svg',
  fastUp:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/23eb.svg',
  femaleTechnologist:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f469-200d-1f4bb.svg',
  ferrisWheel:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f3a1.svg',
  fireEngine:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f692.svg',
  fishingPole:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f3a3.svg',
  framedPicture:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f5bc.svg',
  gift:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f381.svg',
  ghost:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f47b.svg',
  glitchLogo:
  ...
  helmetWithWhiteCross:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/26d1.svg',
  herb:
  ...
  horizontalTrafficLight:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f6a5.svg',
  index:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/261d.svg',
  key:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f511.svg',
  keyboard:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2328.svg',
  ladyBeetle:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f41e.svg',
  lightbulb:
  ...
  lock:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f512.svg',
  loveLetter:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f48c.svg',
  mailboxOpen:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ec.svg',
  microphone:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f3a4.svg',
  mouse:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f5b1.svg',
  musicalKeyboard:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f3b9.svg',
  new:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f195.svg',
  newspaper:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4f0.svg',
  octagonalSign:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f6d1.svg',
  pager:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4df.svg',
  paperclip:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4ce.svg',
  park:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f3de.svg',
  party:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f389.svg',
  playButton:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/25b6.svg',
  policeOfficer:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f46e.svg',
  pushpin:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4cc.svg',
  rainbow:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f308.svg',
  raisingHandWoman:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f64b-200d-2640-fe0f.svg',
  refresh:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f504.svg',
  rocket:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f680.svg',
  scales:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/2696.svg',
  seedling:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f331.svg',
  shuffle:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f500.svg',
  sick:
    'https://twemoji.maxcdn.com/v/latest/svg/1f912.svg',
  slack:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Fslack.svg?v=1568142115840',
  sparkles:
    'https://twemoji.maxcdn.com/v/latest/svg/2728.svg',
  sparklingHeart:
    'https://twemoji.maxcdn.com/v/latest/svg/1f496.svg',
  spiralNotePad:
    'https://twemoji.maxcdn.com/v/latest/svg/1f5d2.svg',
  sunny:
    'https://twemoji.maxcdn.com/v/latest/svg/2600.svg',
  telephone:
    'https://twemoji.maxcdn.com/v/latest/svg/260e.svg',
  television:
    'https://twemoji.maxcdn.com/v/latest/svg/1f4fa.svg',
  thumbsDown:
    'https://twemoji.maxcdn.com/v/latest/svg/1f44e.svg',
  thumbsUp:
    'https://twemoji.maxcdn.com/v/latest/svg/1f44d.svg',
  tokyoTower:
    'https://twemoji.maxcdn.com/v/latest/svg/1f5fc.svg',
  trafficLight:
    'https://twemoji.maxcdn.com/v/latest/svg/1f6a6.svg',
  truck:
    'https://twemoji.maxcdn.com/v/latest/svg/1f69a.svg',
  turtle:
    'https://twemoji.maxcdn.com/v/latest/svg/1f422.svg',
  twitter:
  ...
  umbrella:
    'https://twemoji.maxcdn.com/v/latest/svg/2602.svg',
  verified:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Fverified.svg?v=1568142116735',
  victoryHand:
    'https://twemoji.maxcdn.com/v/latest/svg/270c.svg',
  wave:
    'https://twemoji.maxcdn.com/v/latest/svg/1f44b.svg',
  zzz:
    'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1f4a4.svg',
}
...
export const Icon = ({ icon, alt, emoji, ...props }) => {
  if (emoji) {
    const parsedEmoji = parse(emoji, { base: 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/' });
    return (
      <IconBase
        data-module="Icon"
