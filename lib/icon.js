  ...
  eye: (props) => (  
    <SVGBase viewBox="0 0 19 14" {...props}>
        ...
        <path 
          ...
          stroke="#222" strokeWidth="1.5" strokeLinecap="round" stroke-inejoin="round"/>
        <path 
          d="M8.637 7.868c0-1.082.976-1.96 2.178-1.96 1.203 0 2.179.877 2.179 1.96 0 1.082-.976 1.96-2.179 1.96-1.203 0-2.178-.877-2.178-1.96" fill="#222"/>
    </SVGBase>
  ),
  octocat: (props) => (
...
export const StoryIcon = () => (
  <>
    <p>
      The Icon component renders inline icons, dingbats and emoji in a consistent, cross-platform style.
    </p>
    <CodeExample>{`<Icon icon="x" alt="Close popover" />`}</CodeExample>
    <h3>props</h3>
    <dl>
      <dt>icon <em>(required)</em></dt>
      <dd>The name of the icon. See <a href="#StoryIcon_options">Icon options</a> below for valid values.</dd>
      <dt>size</dt>
      <dd>
        The size of the icon: "tiny", "small", "normal", "big", "bigger", or "huge" for fixed sizes, or "inline" to fit in its surrounding text.
        Defaults to "inline".
      </dd>
      <dt>alt</dt>
...
export const StoryIcon_sizes = () => (
  <>
    <p>
      Icon sizes are configurable with the "size" property, which correspond to the theme's font sizes.
    </p>
    ...
    <p>
      Icons with the size "inline" match the size of their surrounding text.
    </p>
...
export const StoryIcon_options = () => (
  <>
    ...
    <p>
      These icons are implemented as SVGs and match the color of their surrounding text.
    </p>
    <Grid> 
    ...
    <p>
      These icons have consistent colors regardless of their context.
    </p>
    <Grid>
