...
const Chevron = ({ rotate, ...props }) => (
  <SVGBase viewBox="0 0 16 16" {...props}>
    <path d="M12,2 L6,8 L12,14" transform={`translate(8,8) rotate(${rotate}) translate(-8,-8)`} stroke="currentColor" strokeWidth="2" fill="none" />
  </SVGBase>
);
...
const svgs = {
  ...
  chevronLeft: (props) => <Chevron rotate="0" {...props} />,
  chevronRight: (props) => <Chevron rotate="180" {...props} />,
