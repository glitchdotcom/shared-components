...
const ChevronRounded = ({ rotate, ...props }) => (
  <SVGBase viewBox="0 0 9 9" {...props}>
    <path
      d="M3.78378 2.49366C4.17623 2.89603 4.8231 2.89603 5.21555 2.49366L6.9548 0.710415C7.33463 0.320975 7.96072 0.320975 8.34055 0.710415C8.7072 1.08634 8.7072 1.68606 8.34055 2.06198L5.21554 5.26603C4.8231 5.6684 4.17623 5.6684 3.78378 5.26603L0.658777 2.06198C0.292126 1.68606 0.292127 1.08634 0.658778 0.710415C1.03861 0.320975 1.6647 0.320975 2.04453 0.710415L3.78378 2.49366Z"
      fill="currentColor"
      transform={`translate(4.5,4.5) rotate(${rotate}) translate(-4.5,-2.5)`} // NOTE: additional -2px translate up to center icon in viewBox
    />
  </SVGBase>
);
...
const svgs = {
  ...
  chevronRoundedDown: (props) => <ChevronRounded rotate="0" {...props} />,
  chevronRoundedLeft: (props) => <ChevronRounded rotate="90" {...props} />,
  chevronRoundedRight: (props) => <ChevronRounded rotate="-90" {...props} />,
  chevronRoundedUp: (props) => <ChevronRounded rotate="180" {...props} />,
  collapse: (props) => (
