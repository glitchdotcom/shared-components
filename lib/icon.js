...
export const StoryIcons = () => (
  <>
    <Grid items={Object.keys(icons).map((icon) => ({ id: icon }))}>
      {({ id: icon }) => (
        <P size="bigger">
          <Icon icon={icon} /> {icon}
        </P>
    ...
    <H as="h1" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
    <H as="h2" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
    <H as="h3" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
    <H as="h4" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
    <H as="h5" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
    <H as="h6" my={2}>Pinned Projects <Icon icon="pushpin" /></H>
  </>
);