...
const icons = {
  ambulance:
    'http://twemoji.maxcdn.com/v/latest/svg/1f691.svg',
  arrowBackward:
    'http://twemoji.maxcdn.com/v/latest/svg/25c0.svg',
  backhandIndex:
    'http://twemoji.maxcdn.com/v/latest/svg/1f447.svg',
  balloon:
    'http://twemoji.maxcdn.com/v/latest/svg/1f388.svg',
  bentoBox:
    'http://twemoji.maxcdn.com/v/latest/svg/1f371.svg',
  bicep:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4aa.svg',
  blockArrowDown:
    'http://twemoji.maxcdn.com/v/latest/svg/2b07.svg',
  blockArrowUp:
    'http://twemoji.maxcdn.com/v/latest/svg/2b06.svg',
  bomb:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4a3.svg',
  boosted:
    'https://cdn.glitch.com/d7f4f279-e13b-4330-8422-00b2d9211424%2Fboosted-default.png?v=1583253498622',
  bouquet:
    'http://twemoji.maxcdn.com/v/latest/svg/1f490.svg',
  carpStreamer:
    'http://twemoji.maxcdn.com/v/latest/svg/1f38f.svg',
  clap:
    'http://twemoji.maxcdn.com/v/latest/svg/1f44f.svg',
  clapper:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3ac.svg',
  coffin:
    'http://twemoji.maxcdn.com/v/latest/svg/26b0.svg',
  creditCard:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4b3.svg',
  crescentMoon:
    'http://twemoji.maxcdn.com/v/latest/svg/1f319.svg',
  crystalBall:
    'http://twemoji.maxcdn.com/v/latest/svg/1f52e.svg',
  cyclone:
    'http://twemoji.maxcdn.com/v/latest/svg/1f300.svg',
  dancers:
    'http://twemoji.maxcdn.com/v/latest/svg/1f46f-200d-2640-fe0f.svg',
  dev:
  ...
  dogFace:
    'http://twemoji.maxcdn.com/v/latest/svg/1f436.svg',
  earthAsia:
    'http://twemoji.maxcdn.com/v/latest/svg/1f30f.svg',
  email:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4e7.svg',
  eyeglasses:
    'http://twemoji.maxcdn.com/v/latest/svg/1f453.svg',
  eyes:
    'http://twemoji.maxcdn.com/v/latest/svg/1f440.svg',
  facebook:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Ffacebook.png?v=1568142112883',
  faceExpressionless:
    'http://twemoji.maxcdn.com/v/latest/svg/1f611.svg',
  faceSlightlySmiling:
    'http://twemoji.maxcdn.com/v/latest/svg/1f642.svg',
  fastDown:
    'http://twemoji.maxcdn.com/v/latest/svg/23ec.svg',
  fastUp:
    'http://twemoji.maxcdn.com/v/latest/svg/23eb.svg',
  femaleTechnologist:
    'http://twemoji.maxcdn.com/v/latest/svg/1f469-200d-1f4bb.svg',
  ferrisWheel:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3a1.svg',
  fireEngine:
    'http://twemoji.maxcdn.com/v/latest/svg/1f692.svg',
  fishingPole:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3a3.svg',
  framedPicture:
    'http://twemoji.maxcdn.com/v/latest/svg/1f5bc.svg',
  gift:
    'http://twemoji.maxcdn.com/v/latest/svg/1f381.svg',
  ghost:
    'http://twemoji.maxcdn.com/v/latest/svg/1f47b.svg',
  glitchLogo:
    'https://cdn.glitch.com/4bca9911-a70a-46cd-b0b2-f1b103c832d9%2FglitchLogo.svg?v=1569963961866',
  globeWithMeridians:
    'http://twemoji.maxcdn.com/v/latest/svg/1f310.svg',
  google:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Fgoogle.png?v=1568142113626',
  handshake:
    'http://twemoji.maxcdn.com/v/latest/svg/1f91d.svg',
  helmetWithWhiteCross:
    'http://twemoji.maxcdn.com/v/latest/svg/26d1.svg',
  herb:
    'http://twemoji.maxcdn.com/v/latest/svg/1f33f.svg',
  hibiscus:
    'http://twemoji.maxcdn.com/v/latest/svg/1f33a.svg',
  horizontalTrafficLight:
    'http://twemoji.maxcdn.com/v/latest/svg/1f6a5.svg',
  index:
    'http://twemoji.maxcdn.com/v/latest/svg/261d.svg',
  key:
    'http://twemoji.maxcdn.com/v/latest/svg/1f511.svg',
  keyboard:
    'http://twemoji.maxcdn.com/v/latest/svg/2328.svg',
  ladyBeetle:
    'http://twemoji.maxcdn.com/v/latest/svg/1f41e.svg',
  lightbulb:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4a1.svg',
  lightningBolt:
    'http://twemoji.maxcdn.com/v/latest/svg/26a1.svg',
  linkedin:
    'https://cdn.glitch.com/d7f4f279-e13b-4330-8422-00b2d9211424%2Ffooter_icon_linkedin.png?v=1584034393831',
  lock:
    'http://twemoji.maxcdn.com/v/latest/svg/1f512.svg',
  loveLetter:
    'http://twemoji.maxcdn.com/v/latest/svg/1f48c.svg',
  mailboxOpen:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4ec.svg',
  microphone:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3a4.svg',
  mouse:
    'http://twemoji.maxcdn.com/v/latest/svg/1f5b1.svg',
  musicalKeyboard:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3b9.svg',
  new:
    'http://twemoji.maxcdn.com/v/latest/svg/1f195.svg',
  newspaper:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4f0.svg',
  octagonalSign:
    'http://twemoji.maxcdn.com/v/latest/svg/1f6d1.svg',
  pager:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4df.svg',
  paperclip:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4ce.svg',
  park:
    'http://twemoji.maxcdn.com/v/latest/svg/1f3de.svg',
  party:
    'http://twemoji.maxcdn.com/v/latest/svg/1f389.svg',
  playButton:
    'http://twemoji.maxcdn.com/v/latest/svg/25b6.svg',
  policeOfficer:
    'http://twemoji.maxcdn.com/v/latest/svg/1f46e.svg',
  pushpin:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4cc.svg',
  rainbow:
    'http://twemoji.maxcdn.com/v/latest/svg/1f308.svg',
  raisingHandWoman:
    'http://twemoji.maxcdn.com/v/latest/svg/1f64b-200d-2640-fe0f.svg',
  refresh:
    'http://twemoji.maxcdn.com/v/latest/svg/1f504.svg',
  rocket:
    'http://twemoji.maxcdn.com/v/latest/svg/1f680.svg',
  scales:
    'http://twemoji.maxcdn.com/v/latest/svg/2696.svg',
  seedling:
    'http://twemoji.maxcdn.com/v/latest/svg/1f331.svg',
  shuffle:
    'http://twemoji.maxcdn.com/v/latest/svg/1f500.svg',
  sick:
    'http://twemoji.maxcdn.com/v/latest/svg/1f912.svg',
  slack:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Fslack.svg?v=1568142115840',
  sparkles:
    'http://twemoji.maxcdn.com/v/latest/svg/2728.svg',
  sparklingHeart:
    'http://twemoji.maxcdn.com/v/latest/svg/1f496.svg',
  spiralNotePad:
    'http://twemoji.maxcdn.com/v/latest/svg/1f5d2.svg',
  sunny:
    'http://twemoji.maxcdn.com/v/latest/svg/2600.svg',
  telephone:
    'http://twemoji.maxcdn.com/v/latest/svg/260e.svg',
  television:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4fa.svg',
  thumbsDown:
    'http://twemoji.maxcdn.com/v/latest/svg/1f44e.svg',
  thumbsUp:
    'http://twemoji.maxcdn.com/v/latest/svg/1f44d.svg',
  tokyoTower:
    'http://twemoji.maxcdn.com/v/latest/svg/1f5fc.svg',
  trafficLight:
    'http://twemoji.maxcdn.com/v/latest/svg/1f6a6.svg',
  truck:
    'http://twemoji.maxcdn.com/v/latest/svg/1f69a.svg',
  turtle:
    'http://twemoji.maxcdn.com/v/latest/svg/1f422.svg',
  twitter:
    'https://cdn.glitch.com/d7f4f279-e13b-4330-8422-00b2d9211424%2Ffooter_icon_twitter.png?v=1584034389011',
  two:
    'http://twemoji.maxcdn.com/v/latest/svg/32-20e3.svg',
  umbrella:
    'http://twemoji.maxcdn.com/v/latest/svg/2602.svg',
  verified:
    'https://cdn.glitch.com/e7e23ba6-c0ec-4a5a-8dcf-b6f61984cea8%2Fverified.svg?v=1568142116735',
  victoryHand:
    'http://twemoji.maxcdn.com/v/latest/svg/270c.svg',
  wave:
    'http://twemoji.maxcdn.com/v/latest/svg/1f44b.svg',
  zzz:
    'http://twemoji.maxcdn.com/v/latest/svg/1f4a4.svg',
}
