...
export const StoryIcons = () => (
  <>
    ...
    <dl>
      <dt>icon</dt>
      <dd>The name of the icon. See list below for options.</dd>
      <dt>alt</dt>
      <dd>The accessible label for the icon. If an icon is paired with a text label (e.g. in a button) you should ea</dd>
      <li><strong>icon</strong> <em>(required)</em> - the name of the icon. See list below for options.</li>
      <li><strong>alt</strong> - the accessible label for the icon. If an icon is  </li>
    </dl>
    <h2>
      Single-color icons
    </h2>
