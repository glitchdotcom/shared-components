...
const svgs = {
  ...
  private: (props)=> (
    <SVGBase viewBox="0 0 10 12" {...props}>
        <path d="M0 7.006c0-1.108.887-2.006 2-2.006h6.001c1.104 0 2 .887 2 2.006v2.988c0 1.108-.887 2.006-2 2.006h-6.001c-1.104 0-2-.887-2-2.006v-2.988zm5 1.994c.46 0 .833-.373.833-.833 0-.46-.373-.833-.833-.833-.46 0-.833.373-.833.833 0 .46.373.833.833.833z" fill="currentColor"/>
        <path d="M2.235 6.632v-2.995c0-1.107.898-2.005 1.995-2.005h1.451c1.102 0 1.995.895 1.995 1.99v2.768" stroke="currentColor" fill="none" strokeWidth="1.5"/>
    </SVGBase>
  ),
  public: (props)=> (
    
<SVGBase viewBox="0 0 10 12" {...props}>
  <path d="M0 7.006C0 5.898.887 5 2 5h6.001c1.104 0 2 .887 2 2.006v2.988a1.998 1.998 0 0 1-2 2.006H2c-1.104 0-2-.887-2-2.006V7.006zM5 9a.833.833 0 1 0 0-1.666A.833.833 0 0 0 5 9z" fill="currentColor" fillRule="nonzero"/>
  <path d="M2.235 6.632V3.637c0-1.107.898-2.005 1.995-2.005h1.451a1.998 1.998 0 0 1 1.995 1.99" fill="none" stroke="currentColor" strokeWidth="1.5"/>
</SVGBase>
