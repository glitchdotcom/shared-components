...
export const StoryIcon_sizes = () => (
  <>
    ...
    <p>Icon sizes can be overridden with css classes, inline styles, or styled components. Note that many icons are 64x64 pixel PNGs and will not scale well.</p>
    <CodeExample>{code`
      const GiantIcon = styled(Icon)\`
        height: 300px;
      \`
