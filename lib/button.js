...
export const StoryButton = () => (
  <>
    ...
    <PropsDefinition>
      ...
      <Prop name="className">A custom className you want applied to the button</Prop>
      <Prop name="as">The HTML element used by the component. Defaults to "button"; can also be "a" or "span" or any other element.</Prop>
    </PropsDefinition>
  </>
);
