...
export const StoryButton = () => (
  <>
    ...
    <dl>
      <dt>variant</dt>
      <dd>The button style: "primary", "secondary", "shadow", "cta", "warning" (default "primary") -- see below for examples.</dd>
      <dt>size</dt>
      <dd>The size of the text in the button: "tiny", "small", "normal", "big", "bigger", or "huge" (default "normal").</dd>
    </dl>
  </>
);
