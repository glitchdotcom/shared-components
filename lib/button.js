...
const IconButton = React.forwardRef(({ onClick, icon, label, size, iconProps, ...props }, ref) => (
  <IconButtonWrap data-module="IconButton" aria-label="label" onClick={onClick} ref={ref} size={size} {...props}>
