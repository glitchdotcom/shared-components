...
// TODO: secondary, hover colors for these
const darkText = (background) => ({ text: 'black', background })
const lightText = (background) => ({ text: 'white', background })

const colorSystem = (colors) => colors
