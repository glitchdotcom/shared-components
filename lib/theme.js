...
const withContext = ({ hasLightText, background }, { darkText, darkSecondary, lightText, lightSecondary }) => ({
  text: hasLightText ? lightText : darkText,
  secondary: hasLightText ? lightSecondary : darkSecondary,
...
const colorSystem = (options) => {
  ...
  return {
    ...
    private: withContext(options.private, fixedTextColors),
  }
}
