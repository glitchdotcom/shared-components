  ...
  return (
    <>
      <p>
        ...
        It is intended to be used with the components ResultItem, ResultInfo, ResultName and ResultDescription.
      </p>
      <CodeExample>
        {code`
      ...
      <PropsDefinition>
        ...
        <Prop name="children">
          ...
          <dl>
            ...
            <dt>buttonProps</dt>
            <dd>An object containing the props needed to control focus and keyboard navigation on the result items: "ref", "tabIndex" and "onKeyDown".</dd>
          </dl>
        </Prop>
      </PropsDefinition>
      <Container>
