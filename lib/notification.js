...
export const StoryNotification = () => (
  <>
    ...
    <CodeExample>{`<Notification variant="notice">Reconnecting…</Notification>`}</CodeExample>
    <PropsDefinition>
      <Prop name="variant">
        The style of notification: "notice", "success", "error" (default "notice").
      </Prop>
      <Prop name="timeout">
        The time in milliseconds before the notification automatically fades out and calls its "onClose" prop. 
        If no value is provided, the notification will not automatically close. 
      </Prop>
      <Prop name="onClose">
        A callback function, called when the close button is clicked or the notification times out.
        If no value is provided, the notification will not render a close button.
      </Prop>
    </PropsDefinition>
    <h3>variant="notice"</h3>
    <NotificationToggle>
      {(onClose) => <Notification variant="notice" onClose={onClose}>Reconnecting…</Notification>}
    </NotificationToggle>

    <h3>variant="success"</h3>
    <NotificationToggle>
      {(onClose) => (
        <Notification variant="success" onClose={onClose}>
    ...
    <h3>variant="error"</h3>
    <NotificationToggle>
      {(onClose) => <Notification variant="error" onClose={onClose}>Something went wrong. Try refreshing?</Notification>}
    </NotificationToggle>
  </>
);
...
export const StoryNotificationsProvider = () => (
  <>
    <p>The NotificationsProvider component renders a floating container for notifications, and provides a context for </p>
