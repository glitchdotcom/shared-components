...
export const StoryNotification = () => (
  <>
    ...
    <NotificationToggle>{(onClose) => <Notification variant="notice" onClose={onClose} message="Reconnecting…" />}</NotificationToggle>
    ...
    <h3>variant="error"</h3>
    <NotificationToggle>
      {(onClose) => <Notification variant="error" onClose={onClose} message="Something went wrong. Try refreshing?" />}
    </NotificationToggle>
  </>
);
