...
const Content = () => {
  ...
  return (
    <>
      <Button onClick={() => createNotification("This is a notification")}>Create Notification</Button>
      &nbsp;
      <Button onClick={() => createNotification("Success!", { variant: 'success' })}>Create Success Notification</Button>
      &nbsp;
