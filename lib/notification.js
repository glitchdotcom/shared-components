...
export const StoryNotification = () => {
  const [showAddedNotification, setAdded] = React.useState(true)
  return (
    <>
      ...
      {showAddedNotification ? <Notification variant="success" onClose={() => setAdded(false)}>
      ...
      </Notification> : <Button onClick={() => setAdded(true)}>Show Notification</Button>}
      <h3>variant="error"</h3>
