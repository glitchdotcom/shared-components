  ...
  <>
    ...
    <PropsDefinition>
      ...
      <Prop name="onClose">
        ...
        This props is provided by the <code>createNotification</code> callback.
...
const Content = () => {
  ...
  return (
    <>
      ...
      <Button onClick={() => 
        createNotification((props) => (
          <Notification variant="onboarding" {...props} message="Create ana account to keep this project and edit it anywhere.">
            <p style={{ marginTop: 0}}>
              <strong>Create an account</strong> to keep this project, and edit it anywhere.
            </p>
            <Button as="a" href="/signup" variant="cta">
              Create an Account
            </Button>
