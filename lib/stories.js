...
const modules = [animationContainer, avatar, block, button, checkboxButton, iconButton, icon, loader, mark, overlay, popover, resultsList, searchResults, textInput, visuallyHidden];
