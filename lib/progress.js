...
export const Progress = ({ children, ...props }) => (
  <>
    ...
    <ProgressBase data-module="Progress" aria-hidden="true" {...props} />
  </>
);
...
export const StoryProgress = () => (
  <>
    <p>
      The Progress component renders an accessible styled <code>{`<progress>`}</code> element that matches the surrounding text color and background.
    </p>
