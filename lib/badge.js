...
export const StoryBadge_sizes = () => (
  <>
    <p>By default, badges match the size of their surrounding text.</p>
    <h3>Projects <Badge>16</Badge></h3>
    <Container>
      <Button as="span">Tools</Button>
      &nbsp;
      <Button as="span">Tools <Badge variant="error">Error</Badge></Button>
    </Container>
  </>
);
