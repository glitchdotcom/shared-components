...
export const StoryBadge = () => (
  <>
    ...
    <PropsDefinition>
      <Prop name="variant">
        The badge palette: "normal", "inactive", "notice", "success", "warning", "error" (default "normal") -- see below for examples.
      </Prop>
      <Prop name="collapsed">
    ...
    <Container>
      {['Normal', 'Inactive', 'Notice', 'Success', 'Warning', 'Error'].map((label) => (
