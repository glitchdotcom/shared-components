...
export const StoryBlocks_for_Overlay_and_Popover_content = () => (
  <>
    ...
    <PropsDefinition>
      <Prop name="onBack">
        A callback function typically called to render the previous view in a multi-page popover; when present, this renders a "chevronLeft" icon button.
      </Prop>
      <Prop name="onClose">
        A callback function typically called to close the popover or overlay; when present, this renders an "x" icon button.
      </Prop>
      <Prop name="onBackRef">
        A ref to the "onBack" button.
      </Prop>
      <Prop name="onCloseRef">
        A ref to the "onClose" button.
      </Prop>
      <
    </PropsDefinition>
    <p>
      The Info, Actions, and DangerZone components are used for rendering sections in Overlay and Popover components. They have no component-specific props.
    </p>
    <Container>
      <Info>
